...
SRCS = double_to_str.c fill_width.c ft_printf.c ft_strndup.c handlers.c handle_specs.c initializer.c numlen.c print_bin.c print_char.c print_double.c print_format.c print_format_str.c print_hex.c print_int.c print_oct.c print_percent.c print_ptr.c print_str.c reinit.c

OBJS = double_to_str.o fill_width.o ft_printf.o ft_strndup.o handlers.o handle_specs.o initializer.o numlen.o print_bin.o print_char.o print_double.o print_format.o print_format_str.o print_hex.o print_int.o print_oct.o print_percent.o print_ptr.o print_str.o reinit.o
